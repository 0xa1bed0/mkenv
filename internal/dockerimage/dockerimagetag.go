...
func composeImageTagForProject(project *runtime.Project, a, b state.KVStoreKey) string {
	return composeImageTag(composePrefix(project.Path()), a, b)
}
...
func composeImageTag(prefix string, a, b state.KVStoreKey) string {
